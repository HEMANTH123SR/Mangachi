...
export const NavBar = () => {
  return (
    <header className="w-full py-3 px-2 sm:px-5 flex  border-b-2 border-text">
      ...
      <div className="flex w-1/2 md:w-1/3 justify-end items-center space-x-3 sm:space-x-6 ">
        ...
        <div className="bg-primary text-black font-semibold py-2 px-3 rounded-md text-sm sm:text-base">
          Login
        </div>
      </div>
    </header>
